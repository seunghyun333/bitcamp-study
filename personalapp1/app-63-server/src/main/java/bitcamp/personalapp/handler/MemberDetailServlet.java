    ...
    if (member == null) {
      ...
      out.printf("<tr><th style='width:120px;'>사진</th>" + " <td style='width:300px;'>"
          + (member.getPhoto() == null ? "<img style='height:80px' src='/images/avatar.png'>"
              : "<a href='https://kr.object.ncloudstorage.com/bitcamp-nc7-bucket-07/member/%s'>"
                  + "<img src='http://rilqiqaqfxro19010722.cdn.ntruss.com//member/%1$s?type=f&w=60&h=80&faceopt=true&ttype=jpg'>"
                  + "</a>")
      ...
      out.printf("<tr><th>이름</th> <td><input type='text' name='name' value='%s'></td></tr>\n",
          member.getName());
      out.printf("<tr><th>이메일</th> <td><input type='email' name='email' value='%s'></td></tr>\n",
          member.getEmail());
      out.println("<tr><th>암호</th>" + " <td><input type='password' name='pw'></td></tr>");
