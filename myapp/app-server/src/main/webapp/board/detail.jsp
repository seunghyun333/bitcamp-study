...
%>
<a href='https://kr.object.ncloudstorage.com/bitcamp-nc7-bucket-07/board/<%=file.getFilePath()%>'><%=file.getFilePath()%></a>
...
<a href='/board/list.jsp?category=<%=board.getCategory()%>d'>목록</a>
</div>
</form>
