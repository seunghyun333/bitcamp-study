...
public class DispatcherListener implements ActionListener {
  ...
  public DispatcherListener() throws Exception {
	  ...
	  beanContainer.put("boardDao", boardDao);
	    ...
	    beanContainer.put("member/deail", new MemberDetailListener(memberDao));
	    ...
	    beanContainer.put("board/deail", new BoardDetailListener(1, boardDao, sqlSessionFactory));
	    ...
	    beanContainer.put("reading/deail", new BoardDetailListener(2, boardDao, sqlSessionFactory));
