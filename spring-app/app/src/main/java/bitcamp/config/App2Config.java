...
public class App2Config implements WebMvcConfigurer {
  ...
  public ViewResolver viewResolver() {
    System.out.println("App2.config.viewResolver 호출됨");
  ...
  public void configurePathMatch(PathMatchConfigurer configurer) {
    System.out.println("App2.config.configurePathMatch 호출됨");
  ...
  public void addInterceptors(InterceptorRegistry registry) {
    System.out.println("App2.config.addInterceptors 호출됨");
